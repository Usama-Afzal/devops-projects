...
|---|---|
| **Cloud Providers** | AWS (EC2, VPC, S3, RDS, IAM, EKS), Azure, GCP |
| **Infrastructure as Code** | Terraform, AWS CloudFormation |
| **Configuration Management** | Ansible |
| **Containerization & Orchestration** | Docker, Kubernetes (EKS) |
| **CI/CD** | GitHub Actions, Jenkins, AWS CodePipeline |
| **OS & Scripting** | Linux (Ubuntu, RHEL, CentOS), Bash, Python |
| **Monitoring & Troubleshooting** | CloudWatch, ELK Stack, tcpdump, top, nload |
